...
public class CameraViewTest {
    ...
    public void setUpIdlingResource() {
        mCameraViewIdlingResource = new CameraViewIdlingResource(
                (CameraView) rule.getActivity().findViewById(com.google.android.cameraview.test.R.id.camera));
    ...
    public void testSetup() {
        ...
        try {
            onView(withId(com.google.android.cameraview.test.R.id.texture_view))
                    .check(matches(isDisplayed()));
        } catch (NoMatchingViewException e) {
            onView(withId(com.google.android.cameraview.test.R.id.surface_view))
                    .check(matches(isDisplayed()));
        }
    }
    ...
    public void testAspectRatio() {
        final CameraView cameraView = (CameraView) rule.getActivity().findViewById(com.google.android.cameraview.test.R.id.camera);
    ...
    public void testPreviewViewSize() {
        onView(withId(com.google.android.cameraview.test.R.id.camera))
                .check(new ViewAssertion() {
                    ...
                    public void check(View view, NoMatchingViewException noViewFoundException) {
                        CameraView cameraView = (CameraView) view;
                        View preview = view.findViewById(com.google.android.cameraview.test.R.id.texture_view);
                        if (preview == null) {
                            preview = view.findViewById(com.google.android.cameraview.test.R.id.surface_view);
                        }
                        AspectRatio cameraRatio = cameraView.getAspectRatio();
